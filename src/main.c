/*
    Gemini Button code. it should make a esp32 button that casn be pressed and
   an input can be sent to gemini catching the output. This will be fed into a
   Text to speach api. written by: Matthew Ayestan Date:22/08/2025
...
void app_main(void) {
  ...
  // while the button is pressed it should listen to the audio stream and make a
  // audio buffer when a seperate button is pressed the audio buffer (not the
  // question) should be sent to gemini This response at the moment should be in
  // the form of text
